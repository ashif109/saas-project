...
const COLLEGE_ADMIN_ITEMS = [
  ...
  { title: "Faculty", icon: Users, url: "/faculty" },
  { title: "Departments", icon: Layers, url: "/departments" },
  { title: "Attendance", icon: Calendar, url: "/attendance" },
  { title: "Timetable", icon: ClipboardList, url: "/timetable" },
  { title: "Exams", icon: Trophy, url: "/exams" },
  { title: "Fees", icon: CreditCard, url: "/fees" },
  { title: "Scholarships", icon: School, url: "/scholarships" },
  { title: "Doubts", icon: MessageSquare, url: "/doubts" },
